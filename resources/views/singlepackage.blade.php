	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<a href="images/product-1.jpg" class="image-popup"><img src="{{asset('storage/'.  $paket->foto)}}" class="img-fluid" alt="Colorlib Template"></a>
			</div>
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				...
				<p class="price"><span>{{number_format($paket->modal,0)}}</span></p>
				<p>
					{{$paket->deskripsi}}
				</p>

				<p><a href="{{url('pesan', $paket->id)}}" class="btn btn-black py-3 px-5">Pesan Sekarang</a></p>
			</div>
		</div>
	</div>
</section>
